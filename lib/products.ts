...
export const products: Product[] = [
  ...
  },
  {
    ...
    sizes: ["XS", "S", "M", "L", "XL"],
    images: [
      "/minimalist-structured-black-blazer-on-model.jpg",
      "/black-blazer-back-view.jpg",
      "/black-blazer-lapel-detail.jpg",
      "/black-blazer-flat-lay.jpg",
    ],
    description: "Sharp lines and impeccable tailoring define this essential blazer.",
    details: "Peak lapels, single-breasted, two-button closure, interior pockets. Dry clean only.",
